...
# L_Ha = functions.luminosity_from_flux(H_alfa * 10**(0.4 * A_lambda_f_Ha), z) # Ha * 10^(0.4 * A_lambda_f_Ha)
L_Ha = functions.luminosity_from_flux(H_alfa_original * 10**(0.4 * A_lambda_f_Ha), z)
