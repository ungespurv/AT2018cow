...
H_alfa_original = fits.getdata("AT2018cow_Ha.fits")
...
L_Ha_temporary = functions.luminosity_from_flux(
    H_alfa_original * 10 ** (0.4 * A_lambda_f_Ha), z
)
...
#
log_o = functions.metallicity(L_Ha_temporary, L_N_II, L_S_II)
# print(H_alfa_original[193][176])
# print(N_II[193][176])
# print(S_II[193][176])
print(L_Ha[193][176])
print(L_Ha_temporary[193][176])
print(L_N_II[193][176])
print(L_S_II[193][176])
print(log_o[193][176])
