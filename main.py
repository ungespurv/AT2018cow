...
L_Ha = functions.luminosity_from_flux(H_alfa, A_lambda_f_Ha, z)
L_Hb = functions.luminosity_from_flux(H_beta, A_lambda_f_Hb, z)
L_N_II = functions.luminosity_from_flux(N_II, A_lambda_f_0_iii, z)
L_O_III = functions.luminosity_from_flux(O_III, A_lambda_f_0_iii, z)
L_S_II = functions.luminosity_from_flux(S_II, A_lambda_f_s_ii, z)
